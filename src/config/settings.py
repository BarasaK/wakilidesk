...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "firms.context_processors.current_firm_permissions",
            ],
        },
    },
]
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", EMAIL_HOST_USER or "wakiliDesk <no-reply@wakilidesk.local>")
